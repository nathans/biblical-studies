    ...
    for line in lines:
        ...
        if verse_line:
            ...
            for part in beta_root:
                ...
                crasis = False
                if ( ("+" in part) 
                     and (("+" in morph) or (morph.startswith("M")) or 
                          (morph.startswith("X")) or ("-" in beta_word)) 
...
if __name__ == '__main__':
    ...
    # Download
    parser_dl = subparsers.add_parser("download",help="Download the files")
    # Patch
    parser_diff = subparsers.add_parser("patch",help="Apply corrections")
    # Convert
    ...
    # All
    parser_all = subparsers.add_parser("all",help="Complete all actions")
